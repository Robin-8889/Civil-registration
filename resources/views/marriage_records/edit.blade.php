            ...
            <form action="{{ route('marriage_records.update', $marriageRecord) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_of_marriage') is-invalid @enderror"
                        id="date_of_marriage" name="date_of_marriage" value="{{ old('date_of_marriage', $marriageRecord->date_of_marriage) }}" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control mt-2 @error('witness1_name') is-invalid @enderror"
                        id="witness1_name" name="witness1_name" value="{{ old('witness1_name', $marriageRecord->witness1_name) }}" placeholder="Enter witness 1 name">
                    @error('witness1_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control mt-2 @error('witness2_name') is-invalid @enderror"
                        id="witness2_name" name="witness2_name" value="{{ old('witness2_name', $marriageRecord->witness2_name) }}" placeholder="Enter witness 2 name">
                    @error('witness2_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
