...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <h2 class="mb-4">Issue Certificate</h2>
            ...
            <form action="{{ route('certificates.store') }}" method="POST">
                ...
                <ul class="nav nav-tabs mb-4" id="recordTypeTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="birth-tab" data-bs-toggle="tab" data-bs-target="#birth-panel" type="button" role="tab">
                            Birth Records
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="marriage-tab" data-bs-toggle="tab" data-bs-target="#marriage-panel" type="button" role="tab">
                            Marriage Records
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="death-tab" data-bs-toggle="tab" data-bs-target="#death-panel" type="button" role="tab">
                            Death Records
                        </button>
                    </li>
                </ul>

                <!-- Hidden field for record_type (will be set automatically) -->
                <input type="hidden" name="record_type" id="record_type" value="birth">
                <input type="hidden" name="record_id" id="record_id" required>

                <div class="tab-content" id="recordTypeTabContent">
                    <!-- BIRTH RECORDS TAB -->
                    <div class="tab-pane fade show active" id="birth-panel" role="tabpanel">
                        <div class="mb-4">
                                ...
                                <div id="birth_list">
                                    @forelse($birthRecords as $record)
                                        <div class="form-check birth-option mb-2" data-cert="{{ $record->birth_certificate_no }}" data-name="{{ $record->child_first_name }} {{ $record->child_last_name }}">
                                            <input class="form-check-input record-radio" type="radio" name="birth_record_id" id="birth_{{ $record->id }}" value="{{ $record->id }}" data-cert-no="{{ $record->birth_certificate_no }}" data-type="birth">
                    ...
                    <div class="tab-pane fade" id="marriage-panel" role="tabpanel">
                        <div class="mb-4">
                                ...
                                <div id="marriage_list">
                                    @forelse($marriageRecords as $record)
                                        <div class="form-check marriage-option mb-2"
                                            ...
                                            <input class="form-check-input record-radio" type="radio" name="marriage_record_id" id="marriage_{{ $record->id }}" value="{{ $record->id }}" data-cert-no="{{ $record->marriage_certificate_no }}" data-type="marriage">
                    ...
                    <!-- DEATH RECORDS TAB -->
                    <div class="tab-pane fade" id="death-panel" role="tabpanel">
                        <div class="mb-4">
                                ...
                                <div id="death_list">
                                    @forelse($deathRecords as $record)
                                        <div class="form-check death-option mb-2" data-cert="{{ $record->death_certificate_no }}" data-name="{{ $record->deceased->child_first_name ?? '' }} {{ $record->deceased->child_last_name ?? '' }}">
                                            <input class="form-check-input record-radio" type="radio" name="death_record_id" id="death_{{ $record->id }}" value="{{ $record->id }}" data-cert-no="{{ $record->death_certificate_no }}" data-type="death">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('certificate_number') is-invalid @enderror"
                        id="certificate_number" name="certificate_number" value="{{ old('certificate_number') }}" readonly required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('issued_by') is-invalid @enderror"
                        id="issued_by" name="issued_by" value="{{ old('issued_by', Auth::user()->name ?? '') }}" required>
                    @error('issued_by')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('copies_issued') is-invalid @enderror"
                        id="copies_issued" name="copies_issued" value="{{ old('copies_issued', 1) }}" min="1" required>
                    @error('copies_issued')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">Issue Certificate</button>
...
<script>
    ...
    document.querySelectorAll('[data-bs-toggle="tab"]').forEach(tab => {
        tab.addEventListener('shown.bs.tab', function(event) {
            ...
            document.querySelectorAll('.record-radio').forEach(r => r.checked = false);
